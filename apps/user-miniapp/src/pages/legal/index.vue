<template>
  <view class="page legal-page">
    <view class="legal-hero">
      <text class="eyebrow">金闪送用户端</text>
  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        heading: "四、售后和退款",
        items: [
          "商品售后以商品页面、订单页面和实际商家售后规则为准。因缺货、无法配送、异常订单等原因，平台可按规则发起退款。",
    ...
    sections: [
      {
        heading: "一、售后范围",
        items: [
          "平台销售的数码配件售后以商品详情、订单信息、商家承诺和相关法律法规为准。",
      ...
      },
      {
        heading: "二、退款规则",
        items: [
          "因门店无法接单、库存不足、配送不可达等平台或商家原因造成订单无法履约的，平台将协助取消订单或退款。",
          "已完成配送的订单，如需退换货，应保持商品、包装、配件和凭证完整，并按客服或商家指引处理。"
        ]
      },
      {
        heading: "三、风控说明",
