<template>
  <view class="page legal-page">
    <view class="legal-hero">
      <text class="eyebrow">金闪送商家端</text>
    ...
    sections: [
      {
        heading: "一、服务内容",
        items: [
          "商家端为入驻门店提供门店资料管理、商品上传、库存维护、订单接单、履约状态更新、对账和结算查询等功能。",
          "商家应保证商品来源合法、图片和说明真实，不得上传侵权、虚假、违禁或与实际商品不一致的信息。"
        ]
      },
      {
        heading: "二、账号和门店",
        items: [
          "商家通过微信授权登录，并以通过后台审核的入驻手机号绑定门店。门店账号仅限授权人员使用。",
          "商家应妥善保管账号和设备，因账号泄露、内部人员误操作导致的损失，由商家自行承担。"
        ]
      },
      {
        heading: "三、商品和订单履约",
        items: [
          "商家新增或修改商品后需经后台审核，审核通过且库存充足时，商品才会在用户端展示。",
          "用户支付后，商家应在倒计时内接单并按约定备货。拒单、超时或库存不实可能导致订单转单、退款或门店评分降低。"
        ]
      },
      {
        heading: "四、费用和结算",
    ...
    sections: [
      {
        heading: "一、入驻资料",
        items: [
          "商家应提交真实、完整、有效的联系人、手机号、门店名称、营业地址、经营品类、营业执照和门店门头等资料。",
      ...
      },
      {
        heading: "二、经营要求",
        items: [
          "商家应具备销售相关数码配件的合法经营资质，并保证商品质量、库存准确和售后响应。",
          "商家不得通过虚假价格、虚假库存、恶意拒单、刷单、套券等方式扰乱平台秩序。"
        ]
      },
      {
        heading: "三、资料变更",
        items: [
          "门店名称、地址、联系人、经营范围或资质发生变化时，商家应及时在商家端或通过客服提交更新。",
    ...
    sections: [
      {
        heading: "一、我们收集的信息",
        items: [
          "为完成入驻、登录、审核和订单履约，我们可能收集商家微信 openId、手机号、联系人、门店名称、门店地址、经纬度、营业执照、门头照、商品图片和订单操作记录。",
      ...
      },
      {
        heading: "四、资料管理",
        items: [
          "商家可在商家端查看和更新部分门店资料。涉及资质、主体、结算账户等重要资料变更时，需重新提交审核。"
        ]
      }
    ]
  },
    ...
    sections: [
      {
        heading: "一、接单要求",
        items: [
          "用户支付后，商家应在倒计时内确认是否接单，并确保商品、规格、价格和库存与实际一致。",
          "商家接单后应及时备货，等待配送人员取货。若因库存不实、地址不符或内部原因无法履约，应及时联系平台处理。"
        ]
      },
      {
        heading: "二、售后责任",
        items: [
          "因商品错发、漏发、质量问题、包装破损或说明不一致产生的售后，商家应配合平台核实并按规则处理。",
          "商家应保留商品进货、出库、打包、交接等必要凭证，用于订单争议和售后复核。"
        ]
      },
      {
        heading: "三、违规处理",
        items: [
          "商家存在虚假库存、恶意拒单、超时不处理、上传虚假商品图、刷单套券等行为时，平台可限制接单、下架商品或暂停结算。",
